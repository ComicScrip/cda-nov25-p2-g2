...
async function main() {
  ...
  const user1 = await User.create({
    ...
    avatar: "https://img.freepik.com/vecteurs-libre/illustration-du-jeune-homme-souriant_1308-173524.jpg?semt=ais_hybrid&w=740&q=80",
  ...
  const user2 = await User.create({
    ...
    avatar: "https://img.freepik.com/vecteurs-libre/femme-aux-cheveux-longs-sombres_1308-176524.jpg?semt=ais_hybrid&w=740&q=80",
    role : UserRole.Parent
  }).save();
  ...
  const user3 = await User.create({
    ...
    avatar: "https://img.freepik.com/vecteurs-libre/femme-elegante-veste-rouge_1308-176631.jpg?semt=ais_hybrid&w=740&q=80",
    role: UserRole.Staff,
    group: { id: group1.id }
  }).save();
  ...
  const user4 = await User.create({
    ...
    avatar: "https://st2.depositphotos.com/1007566/11226/v/450/depositphotos_112265066-stock-illustration-parent-avatar-design.jpg",
    role: UserRole.Parent,
  ...
  const user5 = await User.create({
    ...
    avatar: "https://img.freepik.com/vecteurs-premium/avatar-femme-souriante_937492-6135.jpg?semt=ais_user_personalization&w=740&q=80",
    role: UserRole.Parent,
    group: null 
  }).save();
  ...
  const user6 = await User.create({
    ...
    avatar: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDqUmyqtPycn1ezYbacsstiCxlPyqL8x2kQQ&s",
    role: UserRole.Staff,
    group: { id: group2.id }
  }).save();
  ...
  const user7 = await User.create({
    ...
    avatar: "https://storage.uk.cloud.ovh.net/v1/AUTH_fa9d327c33094392a5355e4877298168/topassmat-prod/uploads/avatars/2026/1/5061063/thumb_e78f70fb5e.webp",
    role: UserRole.Staff,
    group: { id: group3.id }
  }).save();
  ...
  const child1 = await Child.create({
    ...
    picture: "https://img.freepik.com/photos-gratuite/bebe-sourit-joyeusement_1150-24911.jpg?semt=ais_hybrid&w=740&q=80",
  ...
  const child2 = await Child.create({
    ...
    picture: "https://storage.uk.cloud.ovh.net/v1/AUTH_fa9d327c33094392a5355e4877298168/topassmat-prod/uploads/avatars/2024/8/3595136/thumb_6350e3e030.webp",
  ...
  const child3 = await Child.create({
    ...
    picture: "https://frederic-gras.fr/wp-content/uploads/2020/11/photo-de-creche-1.jpg",
    parents: [ user4, user5],
    group: group3   
  }).save();
  ...
  await Report.create({
    isPresent: true,
    date: "02/10/2026",
    staff_comment: "Super journée pour Ichem ! Il a bien mangé et bien dormi. Il s'est bien amusé sur les chansons",
    baby_mood: baby_moodFormat.Good,
    picture: "https://img.freepik.com/photos-gratuite/adorable-bebe-posant-canape_23-2149355591.jpg?semt=ais_hybrid&w=740&q=80",
    child: child1
  }).save();
  ...
  await Report.create({
    isPresent: true,
    date: "02/10/2026",
    staff_comment: "Bonne journée dans l'ensemble mais n'a pas dormi : un peu ronchon !",
